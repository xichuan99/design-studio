        ...
        <div className="max-w-[1200px] w-full mx-auto flex flex-col flex-1">
          ...
          <header className="flex items-center justify-between bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl px-6 py-4 mb-8 sticky top-4 z-50">
            ...
            <div className="hidden md:flex flex-1 justify-end gap-8 items-center">
              ...
              <div className="flex gap-3">
                <button onClick={() => handleLogin("header_desktop")} className="rounded-lg h-10 px-5 border border-slate-700 hover:bg-slate-800 text-white text-sm font-medium transition-all">
                  Masuk
                </button>
                <button onClick={() => handleJoinWaitlist("header_desktop")} className="rounded-lg h-10 px-5 bg-purple-600 hover:bg-purple-500 text-white text-sm font-bold shadow-[0_0_20px_rgba(108,43,238,0.5)] transition-all">
                  Gabung Waitlist
                </button>
              </div>
            </div>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden bg-slate-900/95 backdrop-blur-xl border border-white/10 rounded-2xl px-6 py-6 mb-4 flex flex-col gap-4 animate-in slide-in-from-top z-40">
              ...
              <button onClick={() => { handleJoinWaitlist("header_mobile"); setMobileMenuOpen(false); }} className="rounded-lg h-12 bg-purple-600 hover:bg-purple-500 text-white font-bold transition-all">
                Gabung Waitlist
              </button>
            </div>
          )}
            ...
            <div className="flex flex-col gap-8 flex-1 lg:pr-10 z-10">
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4">
                <div className="flex flex-col gap-2 w-full sm:w-auto">
                  <button onClick={() => handleJoinWaitlist("hero_primary")} className="flex items-center justify-center gap-2 rounded-xl h-14 px-8 w-full sm:w-auto bg-purple-600 text-white text-lg font-bold shadow-[0_0_20px_rgba(108,43,238,0.5)] hover:bg-purple-500 hover:scale-105 transition-all duration-300">
