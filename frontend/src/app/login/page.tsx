...
import { Brush, LogIn, Mail, User, Loader2, AlertCircle } from "lucide-react";
...
function LoginForm() {
    ...
    return (
        <div className="flex flex-col items-center gap-6 w-full max-w-sm">
            {errorParam && (
                <div className="flex items-center gap-2 bg-red-500/10 border border-red-500/30 rounded-xl px-4 py-3 w-full text-red-300 text-sm">
            ...
            <div className="w-full bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 flex flex-col gap-4">
                <h3 className="text-sm font-semibold text-slate-300 flex items-center gap-2">
                    <LogIn className="h-4 w-4 text-purple-400" />
                    Dev Login (Test Credentials)
                </h3>
                ...
                <div className="flex flex-col gap-3">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full h-11 pl-10 pr-4 bg-white/5 border border-white/10 rounded-xl text-white placeholder:text-slate-600 text-sm focus:outline-none focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/25 transition-all"
                        />
                    </div>
                    <div className="relative">
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center gap-2 rounded-xl h-11 bg-purple-600 hover:bg-purple-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold text-sm transition-all"
                >
                    {loading ? (
