        ...
        try {
            ...
            if (extractedFile) {
                try {
                    ...
                    toast.error(errorMessage.toLowerCase().includes("quota") || errorMessage.includes("413") ? "Gagal mengunggah logo: Kuota penyimpanan Kamu penuh." : "Gagal mengunggah logo, brand kit akan disimpan tanpa logo.");
