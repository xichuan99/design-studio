...
# Ultra Quality (2× Tier 4) - gpt-image-2 via fal.ai
COST_PRODUCT_SCENE_ULTRA = 80
COST_GENERATE_DESIGN_ULTRA = 80
COST_REDESIGN_ULTRA = 80
COST_TEXT_BANNER_PREMIUM_ULTRA = 80

# Ultra Quality (2× Tier 2/3)
COST_BG_SWAP_ULTRA = 20
COST_MAGIC_ERASER_ULTRA = 40
COST_GENERATIVE_EXPAND_ULTRA = 40
