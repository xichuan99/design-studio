...
class BrandKit(Base):
    ...
    logo_url = Column(String, nullable=True) # Keep for backward compatibility/single logo fallback
    ...
    typography = Column(JSON, nullable=True) # Stored as JSON dict: {"primaryFont": "...", "secondaryFont": "..."}
