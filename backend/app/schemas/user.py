...
class UserUpdate(BaseModel):
    name: Optional[str] = Field(
        ...
        json_schema_extra={"example": "Siti Rahma"},
    )
    ...
    model_config = ConfigDict(json_schema_extra={"example": {"name": "Siti Rahma"}})
...
class UserResponse(BaseModel):
    ...
    email: str = Field(
        ...
        json_schema_extra={"example": "siti@example.com"},
    )
    name: str = Field(
    ...
    provider: str = Field(
        ...
        json_schema_extra={"example": "credentials"},
    )
